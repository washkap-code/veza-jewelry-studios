...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://veza-jewelry-studios.lovable.app/og-image.jpg?v=2" },
      { property: "og:image:secure_url", content: "https://veza-jewelry-studios.lovable.app/og-image.jpg?v=2" },
      ...
      { name: "twitter:image", content: "https://veza-jewelry-studios.lovable.app/og-image.jpg?v=2" },
    ...
    links: [
      ...
      { rel: "mask-icon", href: "/favicon.svg?v=2", color: "#4EA085" },
