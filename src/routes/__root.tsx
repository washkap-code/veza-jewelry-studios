...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://veza-jewelry-studios.lovable.app/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "VEZA Jewelry Studios" },
      { name: "twitter:image", content: "https://veza-jewelry-studios.lovable.app/og-image.jpg" },
    ],
    links: [
      ...
      { rel: "mask-icon", href: "/favicon.svg", color: "#4EA085" },
